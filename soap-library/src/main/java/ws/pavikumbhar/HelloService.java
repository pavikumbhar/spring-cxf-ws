 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://pavikumbhar.ws/", wsdlLocation = "http://localhost:7878/services/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://pavikumbhar.ws/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7878/services/hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://pavikumbhar.ws/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pavikumbhar.ws/", "HelloPort"), Hello.class, features);
    }
